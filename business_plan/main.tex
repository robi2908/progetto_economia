...
Al fine di effettuare una prima stima del valore dell'impresa, si calcola il VAN (Valore Attualizzato  Netto),  per  valutare  quanto  è  conveniente  investire  nel  progetto Vinovo. 
Si utilizza la seguente formula,in cui l'EBITDA è un'approssimazione del margine operativo lordo.
...
Si ottiene:
$$ VAN = € 132.884,05 $$
Tale  valore,  essendo  positivo, indica  che  esiste  un  recupero  dell'investimento  fatto. Inoltre, il VAN è una stima attualizzata del valore dell'azienda e il fatto che sia maggiore dell'investimento iniziale configura Vinovo come un business remunerativo per soci ed investitori.
